...
> ⚠️ **Jekyll file type rule:**
> - `.md` files → Jekyll processes Markdown → you CAN use Markdown syntax
> - `.html` files → Jekyll renders HTML literally → you MUST write **pure HTML only**
> - Book pages use `.md` extension. Blog posts use `.html` extension.
> - Writing Markdown in an `.html` file will render as **raw text** on the site.
