...
<div class="social-share" style="margin: 30px 0;">
  ...
  <a href="https://twitter.com/intent/tweet?text=Check out 'The BlackRock Empire' by Michael Rodriguez&url={{ site.url }}{{ site.baseurl }}{{ page.url }}&via=MRodriguezBooks" target="_blank" rel="noopener noreferrer" aria-label="Share on Twitter">
  ...
  <a href="https://www.linkedin.com/shareArticle?mini=true&url={{ site.url }}{{ site.baseurl }}{{ page.url }}&title=The BlackRock Empire by Michael Rodriguez" target="_blank" rel="noopener noreferrer" aria-label="Share on LinkedIn">
  ...
  <a href="mailto:?subject=Check out this book: The BlackRock Empire&body=I thought you might be interested in this book by Michael Rodriguez: {{ site.url }}{{ site.baseurl }}{{ page.url }}" style="display: inline-block; font-size: 24px; " aria-label="Share via Email">
