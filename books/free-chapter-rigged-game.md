...
canonical_url: "https://michaelrodriguezbooks.com/books/free-chapter-rigged-game"
image: "https://michaelrodriguezbooks.com/assets/images/Rigged-Game.webp"
---

# The Rigged Game — Free Preview

**Read the Introduction and first chapter absolutely free.** Discover the $2 trillion secret that the world's richest don't want you to know.

<img src="{{ site.baseurl }}/assets/images/Rigged-Game.webp" alt="THE RIGGED GAME by Michael Rodriguez" style="width: 220px; height: auto; float: right; margin: 0 0 20px 20px; border-radius: 8px;">
...
- How a small group of Dutch merchants in 1602 created the first modern corporation and used it to control half the world's economy
- Why Adam Smith's "invisible hand" was never invisible to those who learned to manipulate it
- How John D. Rockefeller built the first modern monopoly, was broken up by the government, then ended up wealthier and more powerful than before
- Why the 2008 financial crisis was just a dress rehearsal for what's coming next
- How modern "disruption" is actually the oldest wealth concentration game in history, just played with new technology
...
<div style="background: linear-gradient(135deg, #1a1a2e 0%, #16213e 100%); padding: 35px; border-radius: 12px; margin: 40px 0; border: 2px solid #c9a227; text-align: center;">
  <h2 style="color: #c9a227; margin-top: 0;">Want to read the full book?</h2>
  <p style="color: #e8e6e3; font-size: 1.1rem; margin-bottom: 5px;">This is just the beginning. The next 20 chapters reveal how the system was built — from medieval feudalism to Wall Street's modern wealth extraction machine — with names, dates, and dollar amounts.</p>
  ...
  <div style="margin-top: 20px;">
    <a href="https://www.amazon.com/Rigged-Game-Built-System-Keep/dp/B0FNTGG6BZ" class="btn" style="background: #ff9900; color: #000; font-weight: 700; padding: 14px 28px; font-size: 1.1rem; border-radius: 8px; text-decoration: none; display: inline-block;">Buy Full Book on Amazon</a>
  </div>
</div>
