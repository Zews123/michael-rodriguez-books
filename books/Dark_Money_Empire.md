...
<div style="background-color: #1a1a1a; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #1a3c65;">
  ...
  <div class="book-buttons" style="display: flex; flex-wrap: wrap; gap: 10px; margin-bottom: 15px;">
    ...
    <a href="https://www.barnesandnoble.com/w/dark-money-empire-michael-rodriguez/1147832757
" target="_blank" rel="noopener noreferrer" class="book-btn book-btn-bn">🏪 Barnes & Noble</a>
  </div>
...
<div class="social-share" style="margin: 30px 0;">
  ...
  <a href="https://twitter.com/intent/tweet?text=Check out 'Dark Money Empire' by Michael Rodriguez&url={{ site.url }}{{ site.baseurl }}{{ page.url }}&via=MRodriguezBooks" target="_blank" rel="noopener noreferrer" aria-label="Share on Twitter">
  ...
  <a href="https://www.linkedin.com/shareArticle?mini=true&url={{ site.url }}{{ site.baseurl }}{{ page.url }}&title=Dark Money Empire by Michael Rodriguez" target="_blank" rel="noopener noreferrer" aria-label="Share on LinkedIn">
  ...
  <a href="mailto:?subject=Check out this book: Dark Money Empire&body=I thought you might be interested in this book by Michael Rodriguez: {{ site.url }}{{ site.baseurl }}{{ page.url }}" style="display: inline-block; font-size: 24px; " aria-label="Share via Email">
...
<div style="background-color: #1a1a1a; padding: 25px; border-radius: 8px; margin: 30px 0; border: 1px solid #2a2a2a;">
  <h3 style="margin-top: 0; color: #c9a227;">Expose the Dark Money Networks Controlling Your World</h3>
