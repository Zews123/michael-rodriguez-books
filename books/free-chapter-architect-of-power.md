...
<link rel="preload" href="https://michaelrodriguezbooks.com/assets/images/Architect_of_Power.webp" as="image">
...
**Read the full Introduction below.** Henry Kissinger fled Nazi Germany at fifteen. Forty years later, he controlled the foreign policy of the world's most powerful nation. Subscribe below to get Chapter 1 free.

<img src="{{ site.baseurl }}/assets/images/Architect_of_Power.webp" alt="Architect of Power by Michael Rodriguez" style="width: 220px; height: auto; float: right; margin: 0 0 20px 20px; border-radius: 8px;">
...
<div style="background: linear-gradient(135deg, #1a1a2e 0%, #16213e 100%); padding: 35px; border-radius: 12px; margin: 40px 0; border: 2px solid #c9a227; text-align: center;">
  ...
  <p style="color: #e8e6e3; font-size: 1.1rem; margin-bottom: 5px;"><strong>Chapter 1: The Boy from Fürth</strong> — How a Jewish boy in Bavaria lost everything to the Nazis, fled to America, and began building the intellectual framework that would reshape the world.</p>
  ...
  <div id="lead-success" style="display:none;">
    ...
    <a href="{{ site.baseurl }}/assets/downloads/Architect_of_Power_Chapter1.epub"
  ...
  <div style="margin-top: 25px; padding-top: 20px; border-top: 1px solid #333;">
    ...
    <a href="https://www.amazon.com/dp/B0GTWHH893" class="btn" style="background: #ff9900; color: #000; font-weight: 700; padding: 14px 28px; font-size: 1.1rem; border-radius: 8px; text-decoration: none; display: inline-block;">Buy Full Book on Amazon</a>
  </div>
</div>
...
document.getElementById('part1-form').addEventListener('submit', function(e) {
  ...
  fetch('https://api.convertkit.com/v3/tags/17948312/subscribe', {
    method: 'POST',
