...
<img src="{{ site.baseurl }}/assets/images/Shadows_of_Power.webp" alt="Shadows of Power by Michael Rodriguez" style="width: 220px; height: auto; float: right; margin: 0 0 20px 20px; border-radius: 8px;">
...
<div style="background: linear-gradient(135deg, #1a1a2e 0%, #16213e 100%); padding: 35px; border-radius: 12px; margin: 40px 0; border: 2px solid #c9a227; text-align: center;">
  ...
  <p style="color: #e8e6e3; font-size: 1.1rem; margin-bottom: 5px;">The story is just getting started. 13 more explosive chapters reveal how Epstein built his empire of impunity — and who protected him.</p>
