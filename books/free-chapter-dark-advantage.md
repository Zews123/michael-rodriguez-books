...
<link rel="preload" href="{{ site.baseurl }}/assets/images/Dark_Advantage.webp" as="image" type="image/webp">
...
<img src="{{ site.baseurl }}/assets/images/Dark_Advantage.webp" alt="Dark Advantage by Michael Rodriguez" width="220" height="340" style="float: right; margin: 0 0 20px 20px; border-radius: 8px;" fetchpriority="high">
...
<div style="background: linear-gradient(135deg, #1a1a2e 0%, #16213e 100%); padding: 35px; border-radius: 12px; margin: 40px 0; border: 2px solid #c9a227; text-align: center;">
  ...
  <p style="color: #e8e6e3; font-size: 1.1rem; margin-bottom: 5px;"><strong>Chapter 1: The Morality Trap</strong> — Why human morality evolved for tribes of 150 people breaks down catastrophically in organizations of 50,000 — and why empathy is weaponized against you daily.</p>
  ...
  <div id="lead-success" style="display:none;">
    ...
    <a href="{{ site.baseurl }}/assets/downloads/Dark_Advantage_Chapter1.epub"
  ...
  <div style="margin-top: 25px; padding-top: 20px; border-top: 1px solid #333;">
    ...
    <a href="https://www.amazon.com/dp/B0GW9PGHQJ" class="btn" style="background: #ff9900; color: #000; font-weight: 700; padding: 14px 28px; font-size: 1.1rem; border-radius: 8px; text-decoration: none; display: inline-block;">Buy Full Book on Amazon</a>
  </div>
</div>
...
document.getElementById('part1-form').addEventListener('submit', function(e) {
  ...
  fetch('https://api.convertkit.com/v3/tags/18828256/subscribe', {
    method: 'POST',
