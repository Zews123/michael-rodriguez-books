...
<div style="background-color: #1a1a1a; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #1a3c65;">
  <h4 style="margin-top: 0; color: #c9a227;">🏛️ Available Now</h4>
...
.book-btn-apple:hover { background-color: #e8e6e3; }
...
<div class="social-share" style="margin: 30px 0;">
  ...
  <a href="https://twitter.com/intent/tweet?text=Discover how the Medici banking dynasty created the blueprint for modern elite control - 'Secrets of the Medici: The Dark Aristocracy Behind Global Power' by Michael Rodriguez&url={{ site.url }}{{ site.baseurl }}{{ page.url }}&via=MRodriguezBooks" target="_blank" rel="noopener noreferrer" aria-label="Share on Twitter">
  ...
  <a href="https://www.linkedin.com/shareArticle?mini=true&url={{ site.url }}{{ site.baseurl }}{{ page.url }}&title=Secrets of the Medici: The Dark Aristocracy Behind Global Power by Michael Rodriguez" target="_blank" rel="noopener noreferrer" aria-label="Share on LinkedIn">
  ...
  <a href="https://www.reddit.com/submit?url={{ site.url }}{{ site.baseurl }}{{ page.url }}&title=Secrets of the Medici: How Renaissance Banking Dynasties Control Modern Power" target="_blank" rel="noopener noreferrer" aria-label="Share on Reddit">
  ...
  <a href="https://news.ycombinator.com/submitlink?u={{ site.url }}{{ site.baseurl }}{{ page.url }}&t=Secrets of the Medici: How Ancient Banking Dynasties Control Modern Power" target="_blank" rel="noopener noreferrer" aria-label="Share on Hacker News">
    <svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M2 2h20v20H2V2zm10 9.5L7.5 4H9.9l3.15 5.55h.05L16.1 4h2.4l-4.5 7.5V18h-2V11.5z"/></svg>
  </a>
  <a href="mailto:?subject=Check out this book: Secrets of the Medici&body=I thought you might be interested in this investigation into elite power networks by Michael Rodriguez: {{ site.url }}{{ site.baseurl }}{{ page.url }}" style="display: inline-block; font-size: 24px; " aria-label="Share via Email">
    <svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/></svg>
  </a>
</div>
...
<div style="background-color: #1a1a1a; padding: 25px; border-radius: 8px; margin: 30px 0; border: 1px solid #2a2a2a;">
  <h3 style="margin-top: 0; color: #c9a227;">🏛️ Want exclusive insights into elite power networks?</h3>
