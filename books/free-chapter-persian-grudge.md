...
<div style="background: linear-gradient(135deg, #1a1a2e 0%, #16213e 100%); padding: 35px; border-radius: 12px; margin: 40px 0; border: 2px solid #c9a227; text-align: center;">
  ...
  <p style="color: #e8e6e3; font-size: 1.1rem; margin-bottom: 5px;"><strong>Chapter 1: The Golden Trap</strong> — How a bankrupt Australian adventurer paid a Persian shah $480,000 for the right to drill for oil across an area the size of France — and set in motion a century of conflict.</p>
  ...
  <div id="lead-success" style="display:none;">
    ...
    <a href="{{ site.baseurl }}/assets/downloads/Persian_Grudge_Chapter1.epub"
  ...
  <div style="margin-top: 25px; padding-top: 20px; border-top: 1px solid #333;">
    ...
    <a href="https://www.amazon.com/dp/B0GVVSMK42" class="btn" style="background: #ff9900; color: #000; font-weight: 700; padding: 14px 28px; font-size: 1.1rem; border-radius: 8px; text-decoration: none; display: inline-block;">Buy Full Book on Amazon</a>
  </div>
</div>
...
document.getElementById('part1-form').addEventListener('submit', function(e) {
  ...
  fetch('https://api.convertkit.com/v3/tags/18736526/subscribe', {
    method: 'POST',
