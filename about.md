...
- **[Maktoum: The Hidden Dynasty Behind Dubai's Power, Wealth, and the Royal Secrets of a Billionaire Family]({{ site.baseurl }}/books/Maktoum/) (2026)** - *190 years of the Maktoum dynasty — from the 1833 Bedouin secession that founded Dubai to the £554 million Princess Haya divorce, the Burj Khalifa, and the 2024 record GDP of AED 541 billion. Seven rulers, one playbook, one cost ledger. Drawing on UK High Court judgments, declassified British residency records, and forty years of public economic data, Rodriguez assembles both the achievements and what they cost in one volume*
- **[Holy Money: The Vatican's Hidden Empire of Greed]({{ site.baseurl }}/books/Holy_Money/) (2026)** - *Two centuries of Vatican financial scandal — from Napoleon's 1798 invasion to the 2023 Becciu conviction. The definitive investigation into the world's most secretive bank: the IOR, the Sindona-Marcinkus-Calvi triangle, the Banco Ambrosiano collapse, and Pope Francis's incomplete reform agenda*
- **[Dark Advantage: Why Narcissists, Manipulators, and Psychopaths Win at Power]({{ site.baseurl }}/books/Dark_Advantage/) (2026)** - *Why narcissists, manipulators, and psychopaths consistently outperform ethical leaders. A field manual for recognizing dark personalities, decoding their strategies, and building power without losing your soul in a system designed to reward psychopaths*
- **[The Persian Grudge: How Iran and America Became Mortal Enemies]({{ site.baseurl }}/books/Persian_Grudge/) (2026)** - *1953 CIA coup to 2024 nuclear standoff — the full history of how Iran and America became mortal enemies. Declassified documents, verified facts, and the chain of specific, documentable decisions that turned the closest of allies into the bitterest of enemies*
- **[Architect of Power: Henry Kissinger and the Price of World Order]({{ site.baseurl }}/books/Architect_of_Power/) (2026)** - *The definitive investigation into Henry Kissinger's complete arc — from Jewish refugee fleeing Nazi Germany to the most powerful diplomat in American history. Traces the opening to China, Vietnam peace negotiations, Chile coup, shuttle diplomacy, and the devastating civilian cost of realpolitik across three continents*
- **[The Shadow Cabinet: Conspiracy, Power, and the Architecture of Hidden Control]({{ site.baseurl }}/books/Shadow_Cabinet/) (2026)** - *Bilderberg, CFR, MK-Ultra, COINTELPRO, Operation Gladio — the first comprehensive single-volume investigation of secret power networks and verified covert operations. Every claim tested with a five-question Conspiracy Evaluation Framework against declassified documents, congressional testimony, and primary sources*
- **[Countdown to Collapse: The 2040 Crisis]({{ site.baseurl }}/books/Countdown_2040/) (2026)** - *A 1972 computer model predicted civilizational decline by 2040. Fifty years of data prove it right. Rodriguez traces the World3 model, Gaya Herrington's KPMG validation, and three possible futures for industrial civilization*
...
- **[The Bush Machine: Four Generations of Oil, Espionage, and American Power]({{ site.baseurl }}/books/Bush_Machine/) (2025)** - *Inside Bush dynasty's hidden empire - four generations of oil money, CIA connections, and political power shaping American history. Discover how one family controlled U.S. foreign policy for nearly a century.*
- **[The India Paradox: Nuclear Power, Digital Dreams, and a Billion People's Quest for Global Dominance]({{ site.baseurl }}/books/India_Paradox/) (2025)** - *Inside India's transformation to global superpower - nuclear ambitions, tech revolution, and billion-person democracy shaping world order. Discover how the world's largest democracy became its most unpredictable power.*
- **[The Richest Poor Country: Venezuela's Oil Curse and the New Cold War in America's Backyard]({{ site.baseurl }}/books/Richest_Poor_Country/) (2025)** - *Inside Venezuela's transformation from oil paradise to economic collapse - exploring the new Cold War battles in America's backyard and how competing superpowers engineered a nation's destruction*
...
<div style="background-color: #1a1a1a; padding: 25px; border-radius: 8px; margin: 30px 0; border: 1px solid #2a2a2a;">
  <h3 style="margin-top: 0; color: #c9a227;">Get Exclusive Investigative Updates</h3>
